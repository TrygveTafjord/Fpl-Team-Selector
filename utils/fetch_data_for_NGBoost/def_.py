...
def fetch_def_data_for_NGBoost(fetch_test_set: bool) -> pd.DataFrame:
    ...
    if fetch_test_set:
            df = pd.read_csv("../data/2024-25/gws/merged_gw.csv", usecols=def_features)
            df['season'] = '2024-25'
        ...
        df_22_23 = pd.read_csv("../data/2022-23/gws/merged_gw.csv", usecols=def_features)
        df_22_23['season'] = '2022-23'

        # Getting data from 23/24 season
        df_23_24 = pd.read_csv("../data/2023-24/gws/merged_gw.csv", usecols=def_features)
    ...
    # Create Lag Features
    lagged_features = [ 'bps', 'clean_sheets', 'expected_goal_involvements', 
